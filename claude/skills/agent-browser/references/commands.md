...
- [Get Information](#get-information) — `get text|html|value|attr|title|url|count|box|styles`
- [Check State](#check-state) — `is visible|enabled|checked`
- [Screenshots and PDF](#screenshots-and-pdf) — `screenshot`, `pdf`
- [Video Recording](#video-recording) — `record start|stop`
- [Wait](#wait) — wait on selector / ref / ms
- [Mouse Control](#mouse-control) — `mouse move|down|up|wheel`
- [Semantic Locators (alternative to refs)](#semantic-locators-alternative-to-refs) — `find role|text|label|placeholder|...`
- [Browser Settings](#browser-settings) — `set viewport|device|geo|offline|headers|credentials|media`
- [Cookies and Storage](#cookies-and-storage) — `cookies`, `storage`
- [Network](#network) — `network route|unroute|requests|har`
- [Tabs and Windows](#tabs-and-windows) — `tab`, `window`
- [Frames](#frames)
- [Dialogs](#dialogs)
