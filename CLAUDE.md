...
> [`claude/README.md`](claude/README.md)** so the index stays in sync. Same for a shared
> helper — update the table in [`claude/skills/_shared/README.md`](claude/skills/_shared/README.md)
> and grep `claude/skills/` for the callers, since its path is baked into every calling SKILL.md.
